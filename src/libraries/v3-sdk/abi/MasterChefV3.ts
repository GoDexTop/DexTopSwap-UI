export const masterChefV3ABI = [
  ...
  { inputs: [], name: 'NotdextopNFT', type: 'error' },
  ...
  { inputs: [], name: 'ZeroAddress', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'contract IdextopV3Pool', name: 'v3Pool', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IdextopV3Pool', name: '_v3Pool', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'contract IdextopV3Pool', name: 'v3Pool', type: 'address' },
