...
/**
 * The parameters to use in the call to the dextop Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the dextop Router.
   */
  methodName: string
  /**
...
/**
 * Represents the dextop Router, and has static methods for helping execute trades.
 */
