...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, dextopDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | dextopDayData): ChartEntry => ({
