...
const StyledButton = styled("button").withConfig({
  ...
  @media (hover: hover) {
    &:hover:not(:disabled):not(.dextop-button--disabled):not(.dextop-button--disabled):not(:active) {
      opacity: 0.65;
    }
  }

  &:active:not(:disabled):not(.dextop-button--disabled):not(.dextop-button--disabled) {
    opacity: 0.85;
