              ...
              text={
                <>
                  <Text fontSize="12px" mb="12px">
                    Fee ranging from 1% to 0.01% depending on the pool fee tier.
                  </Text>
                  {/* <Text mt="12px">
                    <Link
                      ...
                      ml="4px"
                      external
                      href="https://docs.dextopswap.finance/products/dextopswap-exchange/faq#what-will-be-the-trading-fee-breakdown-for-v3-exchange"
                    >
                  ...
                  <Text mt="10px">
                    ...
                    :{' '}
                    dextopSwap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.
                  </Text> */}
                </>
              }
              ml="4px"
